    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">Rumah Sakit Citra Medika</div>
            </a>
            ...
            @if(auth()->user()->role === 1)
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('rekammedis')}}">
            ...
            @elseif(auth()->user()->role === 3)
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('rawatinap')}}">
                        <i class="fas fa-procedures"></i>
                        <span>Data Rawat Inap</span></a>
                </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Rumah Sakit Citra Medika 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
